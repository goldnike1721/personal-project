const carousel = document.querySelector('.top-choice-animated-carousel');
const carouselInner = carousel.querySelector('.top-choice-animated-carousel__inner');
const prevButton = carousel.querySelector('.top-choice-animated-carousel__button--prev');
const nextButton = carousel.querySelector('.top-choice-animated-carousel__button--next');
